...
SUDO_USERS = {int(x) for x in os.environ.get("SUDO_USERS", "1220829364").split()}
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/b691ddccd3d94d2a7c302.jpg"
        ...
        async def opeen(event):
            try:
                ...
                if tgbotusername is not None:
                    ...
                    await event.edit(
                        "`Botnya tidak berfungsi! Silakan atur Bot Token dan Nama Pengguna dengan benar. The module has been stopped.`"
                    )
            except Exception:
