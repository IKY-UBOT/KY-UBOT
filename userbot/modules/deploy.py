...
async def _(event):
    ...
    animation_chars = [
        "Heroku Connecting To Latest Github Build (DIORrios285/DIOR-UBOT)",
        ...
        "INFO - DIOR-UBOT: Logged in as 557667062",
        "INFO - DIOR-UBOT: Successfully...",
        "919852+00:00 app[worker.1]: 919 - Rose-Userbot -",
        "INFO - ⚡ DIOR-UBOT ⚡ ⚙️ V5.0 [TELAH DIAKTIFKAN!]",
        "**Build Succeeded**",
    ]
